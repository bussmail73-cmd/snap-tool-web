...
const LIVE_HOST = "https://ranatalha72-snap-tool-web.hf.space";
...
async function runAllTests() {
  console.log("=".repeat(60));
  console.log(`STARTING LIVE ENDPOINT COMPREHENSIVE AUDIT ON: ${LIVE_HOST}`);
  console.log("=".repeat(60));
  ...
  console.log("=".repeat(60));
  console.log("LIVE ENDPOINT COMPREHENSIVE AUDIT COMPLETE!");
  console.log("=".repeat(60));
}
